...
namespace ADNES.Tests.CPU
{
    ...
    public class LDA_Tests
    {
        ...
        {
            var mapper = new NROM([0xA9, 0x01], null);
        ...
        {
            var mapper = new NROM([0xA9, 0x80], null);
            var cpu = new Core(mapper);
        ...
        {
            var mapper = new NROM([0xA5, 0x00], null);
            var cpu = new Core(mapper);
        ...
        {
            var mapper = new NROM([0xB5, 0x00], null);
        ...
        {
            var mapper = new NROM([0xAD, 0x03, 0xC0, 0x01], null);
            var cpu = new Core(mapper);
        ...
        {
            var mapper = new NROM([0xBD, 0x02, 0xC0, 0x01], null);
            var cpu = new Core(mapper) { X = 1 };
        ...
        {
            var mapper = new NROM([0xBD, 0xFF, 0xC0], null);
            var cpu = new Core(mapper) { X = 1 };
        ...
        {
            var mapper = new NROM([0xB9, 0x02, 0xC0, 0x01], null);
        ...
        {
            var mapper = new NROM([0xB9, 0xFF, 0xC0], null);
            var cpu = new Core(mapper) { Y = 1 };
            cpu.CPUMemory.WriteByte(0xC100, 0x01);
        ...
        {
            var mapper = new NROM([0xA1, 0x01, 0xC0, 0x00], null);
            var cpu = new Core(mapper) { X = 1 };
            cpu.CPUMemory.WriteByte(0x00, 0x01);
        ...
        {
            var mapper = new NROM([0xB1, 0x00], null);
            var cpu = new Core(mapper) { Y = 1 };
            cpu.CPUMemory.WriteByte(0x00, 0x01);
