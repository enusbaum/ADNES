...
namespace ADNES.Tests.CPU
{
    ...
    public class ADC_Tests
    {
        ...
        {
            var mapper = new NROM([0x69, 0x01], null);
        ...
        {
            var mapper = new NROM([0x69, 0x02], null);
            var memory = new Memory(mapper, null);
        ...
        {
            var mapper = new NROM([0x69, 0x81], null);
            var memory = new Memory(mapper, null);
        ...
        {
            var mapper = new NROM([0x65, 0x00], null);
            var cpu = new Core(mapper);
        ...
        {
            var mapper = new NROM([0x75, 0x00], null);
