...
namespace ADNES.Tests.CPU
{
    ...
    public class ROL_Tests
    {
        ...
        {
            var mapper = new NROM([0x26, 0x00], null);
        ...
        {
            var mapper = new NROM([0x36, 0x00], null);
        ...
        {
            var mapper = new NROM([0x2E, 0x03, 0xC0, 0x3F], null);
            var cpu = new Core(mapper);
        ...
        {
            var mapper = new NROM([0x2E, 0x03, 0xC0, 0xBF], null);
            var cpu = new Core(mapper);
        ...
        {
            var mapper = new NROM([0x2E, 0x03, 0xC0, 0x7F], null);
            var cpu = new Core(mapper);
        ...
        {
            var mapper = new NROM([0x2E, 0x03, 0xC0, 0xFF], null);
            var cpu = new Core(mapper);
            cpu.Status.Carry = true;
        ...
        {
            var mapper = new NROM([0x3E, 0x02, 0xC0, 0x3F], null);
            var cpu = new Core(mapper) { X = 1 };
        ...
        {
            var mapper = new NROM([0x3E, 0x02, 0xC0, 0xBF], null);
            var cpu = new Core(mapper) { X = 1 };
        ...
        {
            var mapper = new NROM([0x3E, 0x02, 0xC0, 0x7F], null);
            var cpu = new Core(mapper) { X = 1 };
        ...
        {
            var mapper = new NROM([0x3E, 0x02, 0xC0, 0xFF], null);
            var cpu = new Core(mapper) { X = 1 };
            cpu.Status.Carry = true;
