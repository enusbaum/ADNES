...
namespace ADNES.Tests.CPU
{
    ...
    public class EOR_Tests
    {
        ...
        {
            var mapper = new NROM([0x49, 0xFF], null);
        ...
        {
            var mapper = new NROM([0x49, 0x7F], null);
            var cpu = new Core(mapper) { A = 0xFF };
        ...
        {
            var mapper = new NROM([0x45, 0x00], null);
            var cpu = new Core(mapper) { A = 0xFF };
        ...
        {
            var mapper = new NROM([0x55, 0x00], null);
        ...
        {
            var mapper = new NROM([0x4D, 0x03, 0xC0, 0xFF], null);
            var cpu = new Core(mapper) { A = 0xFF };
            cpu.CPUMemory.WriteByte(0x01, 0xFF);
        ...
        {
            var mapper = new NROM([0x5D, 0x02, 0xC0, 0xFF], null);
            var cpu = new Core(mapper) { A = 0xFF, X = 1 };
        ...
        {
            var mapper = new NROM([0x5D, 0x01, 0xC0], null);
        ...
        {
            var mapper = new NROM([0x59, 0x02, 0xC0, 0xFF], null);
        ...
        {
            var mapper = new NROM([0x59, 0x01, 0xC0], null);
        ...
        {
            var mapper = new NROM([0x41, 0x00], null);
            var cpu = new Core(mapper) { A = 0xFF, X = 1 };
