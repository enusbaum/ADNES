...
namespace ADNES.Tests.CPU
{
    ...
    public class CPY_Tests
    {
        ...
        {
            var mapper = new NROM([0xC0, 0x7E], null);
        ...
        {
            var mapper = new NROM([0xC0, 0x7F], null);
            var cpu = new Core(mapper) { Y = 0x7F };
        ...
        {
            var mapper = new NROM([0xC0, 0x01], null);
        ...
        {
            var mapper = new NROM([0xC4, 0x00], null);
            var cpu = new Core(mapper) { Y = 0x7F };
        ...
        {
            var mapper = new NROM([0xCC, 0x03, 0xC0, 0x7E], null);
            var cpu = new Core(mapper) { Y = 0x7F };
