...
namespace ADNES.Tests.CPU
{
    ...
    public class ORA_Tests
    {
        ...
        {
            var mapper = new NROM([0x09, 0x55], null);
        ...
        {
            var mapper = new NROM([0x09, 0x00], null);
        ...
        {
            var mapper = new NROM([0x05, 0x00], null);
            var cpu = new Core(mapper) { A = 0xAA };
        ...
        {
            var mapper = new NROM([0x15, 0x00], null);
        ...
        {
            var mapper = new NROM([0x0D, 0x03, 0xC0, 0x55], null);
            var cpu = new Core(mapper) { A = 0xAA };
        ...
        {
            var mapper = new NROM([0x1D, 0x02, 0xC0, 0x55], null);
            var cpu = new Core(mapper) { A = 0xAA, X = 1 };
        ...
        {
            var mapper = new NROM([0x1D, 0x01, 0xC0], null);
        ...
        {
            var mapper = new NROM([0x19, 0x02, 0xC0, 0x55], null);
        ...
        {
            var mapper = new NROM([0x19, 0x01, 0xC0], null);
        ...
        {
            var mapper = new NROM([0x01, 0x00], null);
            var cpu = new Core(mapper) { A = 0xAA, X = 1 };
        ...
        {
            var mapper = new NROM([0x11, 0x00], null);
            var cpu = new Core(mapper) { A = 0xAA, Y = 1 };
        ...
        {
            var mapper = new NROM([0x51, 0x00], null);
            var cpu = new Core(mapper) { A = 0xAA, Y = 1 };
