...
namespace ADNES.Tests.CPU
{
    ...
    public class DEC_Tests
    {
        ...
        {
            var mapper = new NROM([0xC6, 0x00], null);
        ...
        {
            var mapper = new NROM([0xD6, 0x00], null);
        ...
        {
            var mapper = new NROM([0xCE, 0x03, 0xC0, 0x02], null);
            var cpu = new Core(mapper) { X = 0x01 };
        ...
        {
            var mapper = new NROM([0xDE, 0x02, 0xC0, 0x02], null);
            var cpu = new Core(mapper) { X = 0x01 };
