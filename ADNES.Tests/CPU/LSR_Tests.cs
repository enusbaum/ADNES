...
namespace ADNES.Tests.CPU
{
    ...
    public class LSR_Tests
    {
        ...
        {
            var mapper = new NROM([0x46, 0x00], null);
        ...
        {
            var mapper = new NROM([0x56, 0x00], null);
        ...
        {
            var mapper = new NROM([0x4E, 0x03, 0xC0, 0x80], null);
            var cpu = new Core(mapper);
        ...
        {
            var mapper = new NROM([0x5E, 0x02, 0xC0, 0x80], null);
            var cpu = new Core(mapper) { X = 1 };
