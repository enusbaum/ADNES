...
namespace ADNES.Tests.CPU
{
    ...
    public class LDX_Tests
    {
        ...
        {
            var mapper = new NROM([0xA2, 0x01], null);
        ...
        {
            var mapper = new NROM([0xA2, 0x80], null);
            var cpu = new Core(mapper);
        ...
        {
            var mapper = new NROM([0xA6, 0x00], null);
            var cpu = new Core(mapper);
        ...
        {
            var mapper = new NROM([0xB6, 0x00], null);
        ...
        {
            var mapper = new NROM([0xAE, 0x03, 0xC0, 0x01], null);
            var cpu = new Core(mapper);
        ...
        {
            var mapper = new NROM([0xBE, 0x02, 0xC0, 0x01], null);
            var cpu = new Core(mapper) { Y = 1 };
        ...
        {
            var mapper = new NROM([0xBE, 0xFF, 0xC0], null);
            var cpu = new Core(mapper) { Y = 1 };
