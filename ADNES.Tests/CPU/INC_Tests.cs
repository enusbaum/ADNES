...
namespace ADNES.Tests.CPU
{
    ...
    public class INC_Tests
    {
        ...
        {
            var mapper = new NROM([0xE6, 0x00], null);
        ...
        {
            var mapper = new NROM([0xF6, 0x00], null);
        ...
        {
            var mapper = new NROM([0xEE, 0x03, 0xC0, 0xFF], null);
            var cpu = new Core(mapper);
        ...
        {
            var mapper = new NROM([0xFE, 0x03, 0xC0, 0x00, 0xFF], null);
            var cpu = new Core(mapper) { X = 1 };
