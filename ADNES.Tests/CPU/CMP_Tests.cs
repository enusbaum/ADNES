...
namespace ADNES.Tests.CPU
{
    ...
    public class CMP_Tests
    {
        ...
        {
            var mapper = new NROM([0xC9, 0x01], null);
        ...
        {
            var mapper = new NROM([0xC9, 0x80], null);
        ...
        {
            var mapper = new NROM([0xC9, 0x7E], null);
            var cpu = new Core(mapper) { A = 0x7E };
        ...
        {
            var mapper = new NROM([0xC5, 0x00], null);
            var cpu = new Core(mapper) { A = 0x7E };
        ...
        {
            var mapper = new NROM([0xD5, 0x00], null);
        ...
        {
            var mapper = new NROM([0xCD, 0x03, 0xC0, 0x7E], null);
            var cpu = new Core(mapper) { A = 0x7E };
        ...
        {
            var mapper = new NROM([0xDD, 0x03, 0xC0, 0x00, 0x7E], null);
            var cpu = new Core(mapper) { A = 0x7E, X = 1 };
        ...
        {
            var mapper = new NROM([0xDD, 0xFF, 0xC0], null);
            var cpu = new Core(mapper) { A = 0x7E, X = 1 };
        ...
        {
            var mapper = new NROM([0xD9, 0x03, 0xC0, 0x00, 0x7E], null);
        ...
        {
            var mapper = new NROM([0xD9, 0xFF, 0xC0], null);
            var cpu = new Core(mapper) { A = 0x7E, Y = 1 };
            cpu.CPUMemory.WriteByte(0xC100, 0x7E);
        ...
        {
            var mapper = new NROM([0xC1, 0x00], null);
            var cpu = new Core(mapper) { A = 0x7E, X = 1 };
        ...
        {
            var mapper = new NROM([0xD1, 0x00], null);
