...
namespace ADNES.Tests.CPU
{
    ...
    public class ROR_Tests
    {
        ...
        {
            var mapper = new NROM([0x66, 0x00], null);
        ...
        {
            var mapper = new NROM([0x76, 0x00], null);
        ...
        {
            var mapper = new NROM([0x6E, 0x03, 0xC0, 0x02], null);
            var cpu = new Core(mapper);
        ...
        {
            var mapper = new NROM([0x6E, 0x03, 0xC0, 0x03], null);
            var cpu = new Core(mapper);
        ...
        {
            var mapper = new NROM([0x6E, 0x03, 0xC0, 0x00], null);
            var cpu = new Core(mapper);
            cpu.Status.Carry = true;
        ...
        {
            var mapper = new NROM([0x7E, 0x02, 0xC0, 0x02], null);
            var cpu = new Core(mapper) { X = 1 };
        ...
        {
            var mapper = new NROM([0x7E, 0x02, 0xC0, 0x03], null);
            var cpu = new Core(mapper) { X = 1 };
        ...
        {
            var mapper = new NROM([0x7E, 0x02, 0xC0, 0x00], null);
            var cpu = new Core(mapper) { X = 1 };
            cpu.Status.Carry = true;
